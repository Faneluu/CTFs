...
# XOR decrypt
decrypted_data = xor_decrypt(decoded_data.decode('latin1'), key)

# Decompress
command = zlib.decompress(decrypted_data.encode('latin1')).decode('latin1')
print(command)
